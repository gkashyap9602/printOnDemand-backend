...
module.exports.profileSchema = {
    body: joi.object({
        ...
        paymentDetails: {
            ...
            phone: joi.string().max(10).message("Phone length must be 10").min(10).message("Phone length must be 10"),
        },
        billingAddress: {
            address1: joi.string(),
            ...
            companyPhone: joi.string().max(10).message("Phone length must be 10").min(10).message("Phone length must be 10"),
