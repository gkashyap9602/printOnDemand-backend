...
const categoryUtil = {
    ...
    updateCategory: async (data, file) => {
        try {
            ...
            return helpers.showResponse(true, ResponseMessages?.category.category_updated, result?.data, null, 200);
        }
        catch (err) {
            return helpers.showResponse(false, err?.message, null, null, 400);
    ...
    updateSubcategory: async (data, file) => {
        try {
            ...
            if (!find.status) {
                return helpers.showResponse(false, ResponseMessages?.category.subcategory_not_exist, result?.data, null, 203);
            }
    ...
    deleteCategory: async (data, file) => {
        try {
            const { name, description, categoryId } = data
